...
from algo_ts.data.batch import _alloc_by_keys_diff
from algo_ts.env import BaseVectorEnv, DummyVectorEnv
from algo_ts.policy import BasePolicy
...
class Collector(object):
    ...
    :param policy: an instance of the :class:`~algo_torch.policy.BasePolicy` class.
    :param env: a ``gym.Env`` environment or an instance of the
        :class:`~algo_torch.env.BaseVectorEnv` class.
    :param buffer: an instance of the :class:`~algo_torch.data.ReplayBuffer` class.
    ...
    dict or a :class:`~algo_torch.data.Batch` with the modified keys and values. Examples
...
class AsyncCollector(Collector):
    ...
    The arguments are exactly the same as :class:`~algo_torch.data.Collector`, please
    refer to :class:`~algo_torch.data.Collector` for more detailed explanation.
    """
