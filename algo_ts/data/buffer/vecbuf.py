...
class VectorReplayBuffer(ReplayBufferManager):
    ...
    are the same as :class:`~algo_torch.data.ReplayBuffer`.

    .. seealso::

        Please refer to :class:`~algo_torch.data.ReplayBuffer` for other APIs' usage.
    """
...
class PrioritizedVectorReplayBuffer(PrioritizedReplayBufferManager):
    ...
    sample_avail) are the same as :class:`~algo_torch.data.PrioritizedReplayBuffer`.
