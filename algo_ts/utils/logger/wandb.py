...
from algo_ts.utils import BaseLogger, TensorboardLogger
from algo_ts.utils.logger.base import LOG_DATA_TYPE
...
class WandbLogger(BaseLogger):
    ...
    :param str project: W&B project name. Default to "algo_torch".
    ...
    def __init__(
        ...
        self.restored = False
        if project is None:
            project = os.getenv("WANDB_PROJECT", "algo_torch")
        ...
        self.wandb_run._label(repo="algo_torch")  # type: ignore
