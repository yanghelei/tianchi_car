...
from algo_ts.data import Batch, ReplayBuffer
from algo_ts.exploration import BaseNoise, GaussianNoise
...
class DDPGPolicy(BasePolicy):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        :return: A :class:`~algo_torch.data.Batch` which has 2 keys:
