...
from algo_ts.data import Batch, ReplayBuffer, to_numpy
from algo_ts.policy import DQNPolicy, QRDQNPolicy
from algo_ts.utils.net.discrete import FractionProposalNetwork, FullQuantileFunction
...
class FQFPolicy(QRDQNPolicy):
    ...
    .. seealso::
        ...
        Please refer to :class:`~algo_torch.policy.QRDQNPolicy` for more detailed
        explanation.
    """
