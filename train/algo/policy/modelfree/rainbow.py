...
from algo.data import Batch
from algo.policy import C51Policy
from algo.utils.net.discrete import sample_noise
...
class RainbowPolicy(C51Policy):
    ...
    .. seealso::
        ...
        Please refer to :class:`~algo_torch.policy.C51Policy` for more detailed
        explanation.
    """
