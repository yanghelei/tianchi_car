...
from algo.data.batch import _alloc_by_keys_diff, _create_value
from algo.data.utils.converter import from_hdf5, to_hdf5


class ReplayBuffer:
    """:class:`~algo_torch.data.ReplayBuffer` stores data generated from interaction \
